...
object RecommenderApp {
  ...
  def runSpark() = {
    ...
    val userWholeList: Seq[String] = FileSys.readDir(Cons.USERS_PATH).take(300)
    val userList: Seq[Seq[String]] = List(userWholeList.slice(0, 100), userWholeList.slice(100, 200), userWholeList.slice(200, 300)) //splitThirds(userWholeList)
